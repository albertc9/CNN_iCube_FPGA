...
if {${::AESL::PGuard_rtl_comp_handler}} {
	::AP::rtl_comp_handler myproject_sigmoid_array_array_ap_fixed_16_6_5_3_0_1u_sigmoid_config8_s_sigmoid_table_ROeOg BINDTYPE {storage} TYPE {rom} IMPL {auto} LATENCY 2 ALLOW_PRAGMA 1
}
...
eval "cg_default_interface_gen_dc { \
    ...
    op interface \
    ports { layer7_out_dout { I 16 vector } layer7_out_num_data_valid { I 2 vector } layer7_out_fifo_cap { I 2 vector } layer7_out_empty_n { I 1 bit } layer7_out_read { O 1 bit } } \
} "
}
