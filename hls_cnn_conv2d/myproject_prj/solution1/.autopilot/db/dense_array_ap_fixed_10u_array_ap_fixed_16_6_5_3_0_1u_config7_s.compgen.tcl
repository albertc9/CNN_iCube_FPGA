...
eval "cg_default_interface_gen_dc { \
    ...
    op interface \
    ports { layer7_out_din { O 16 vector } layer7_out_num_data_valid { I 2 vector } layer7_out_fifo_cap { I 2 vector } layer7_out_full_n { I 1 bit } layer7_out_write { O 1 bit } } \
} "
}
