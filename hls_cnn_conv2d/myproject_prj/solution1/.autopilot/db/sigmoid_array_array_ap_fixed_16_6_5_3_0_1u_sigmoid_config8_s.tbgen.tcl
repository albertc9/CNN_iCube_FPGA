set moduleName sigmoid_array_array_ap_fixed_16_6_5_3_0_1u_sigmoid_config8_s
set isTopModule 0
...
set C_modelName {sigmoid<array,array<ap_fixed<16,6,5,3,0>,1u>,sigmoid_config8>}
...
set Spec2ImplPortList { 
	layer7_out { ap_fifo {  { layer7_out_dout fifo_data_in 0 16 }  { layer7_out_num_data_valid fifo_status_num_data_valid 0 2 }  { layer7_out_fifo_cap fifo_update 0 2 }  { layer7_out_empty_n fifo_status 0 1 }  { layer7_out_read fifo_port_we 1 1 } } }
