...
entity myproject_dense_array_array_ap_fixed_16_6_5_3_0_1u_config7_Pipeline_DataPrepare is
port (
    ap_clk : IN STD_LOGIC;
    ap_rst : IN STD_LOGIC;
...
architecture behav of myproject_dense_array_array_ap_fixed_16_6_5_3_0_1u_config7_Pipeline_DataPrepare is 
...
attribute shreg_extract : string;
    ...
    signal icmp_ln33_fu_50_p2 : STD_LOGIC_VECTOR (0 downto 0);
    signal ap_condition_exit_pp0_iter0_stage0 : STD_LOGIC;
    signal ap_loop_exit_ready : STD_LOGIC;
    signal ap_ready_int : STD_LOGIC;
    signal layer5_out_blk_n : STD_LOGIC;
    signal ap_block_pp0_stage0 : BOOLEAN;
    signal i_in_fu_32 : STD_LOGIC_VECTOR (7 downto 0) := "00000000";
    signal add_ln33_fu_56_p2 : STD_LOGIC_VECTOR (7 downto 0);
...
begin
    ...
    i_in_fu_32_assign_proc : process (ap_clk)
    begin
        if (ap_clk'event and ap_clk = '1') then
            if (((ap_const_boolean_0 = ap_block_pp0_stage0_11001) and (ap_const_logic_1 = ap_CS_fsm_pp0_stage0))) then
                if (((icmp_ln33_fu_50_p2 = ap_const_lv1_0) and (ap_enable_reg_pp0_iter0 = ap_const_logic_1))) then 
                    i_in_fu_32 <= add_ln33_fu_56_p2;
                elsif ((ap_loop_init = ap_const_logic_1)) then 
                    i_in_fu_32 <= ap_const_lv8_0;
                end if;
            end if; 
        end if;
    end process;
    ...
    add_ln33_fu_56_p2 <= std_logic_vector(unsigned(ap_sig_allocacmp_i_in_1) + unsigned(ap_const_lv8_1));
    ...
    ap_condition_exit_pp0_iter0_stage0_assign_proc : process(ap_CS_fsm_pp0_stage0, ap_enable_reg_pp0_iter0, ap_block_pp0_stage0_subdone, icmp_ln33_fu_50_p2)
    begin
        if (((icmp_ln33_fu_50_p2 = ap_const_lv1_1) and (ap_const_boolean_0 = ap_block_pp0_stage0_subdone) and (ap_enable_reg_pp0_iter0 = ap_const_logic_1) and (ap_const_logic_1 = ap_CS_fsm_pp0_stage0))) then 
    ...
    ap_sig_allocacmp_i_in_1_assign_proc : process(ap_CS_fsm_pp0_stage0, ap_block_pp0_stage0, i_in_fu_32, ap_loop_init)
    begin
        if (((ap_loop_init = ap_const_logic_1) and (ap_const_boolean_0 = ap_block_pp0_stage0) and (ap_const_logic_1 = ap_CS_fsm_pp0_stage0))) then 
            ap_sig_allocacmp_i_in_1 <= ap_const_lv8_0;
        else 
            ap_sig_allocacmp_i_in_1 <= i_in_fu_32;
        end if; 
    end process;

    icmp_ln33_fu_50_p2 <= "1" when (ap_sig_allocacmp_i_in_1 = ap_const_lv8_EE) else "0";
